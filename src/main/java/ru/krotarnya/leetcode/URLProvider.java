...
public class URLProvider {
    ...
    private static final String GITHUB_PROBLEM_TEMPLATE = 
            "https://github.com/illepidus/Leetcode/blob/master/src/main/java/ru/krotarnya/leetcode/problem/p%04d/Solution.java";
    
    public URL leetcode(String problemName) {
        return urlOf(String.format(LEETCODE_PROBLEM_TEMPLATE, problemName));
    }

    public URL gitHub(int problemId) {
        return urlOf(String.format(GITHUB_PROBLEM_TEMPLATE, problemId));
    }
